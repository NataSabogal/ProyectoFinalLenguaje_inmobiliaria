...
public class VentanaLogIn extends javax.swing.JFrame {
    ...
    public VentanaLogIn(ControladorUsuario userController, ControladorPropiedad propiedadController) {
        initComponents();
    ...
    private void btnAccederActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccederActionPerformed
        ...
        if (aux != null) {
            if (aux.getRol() == RolUsuario.ADMINISTRADOR) {
                ...
                VentanaPrincipalEmpleado vista = new VentanaPrincipalEmpleado(userController, propiedadController);
                vista.setVisible(true);
                vista.setLocationRelativeTo(null);
                this.dispose();

            } else if (aux.getRol() == RolUsuario.CLIENTE) {
                VentanaPrincipalCliente vista = new VentanaPrincipalCliente(userController, propiedadController);
                vista.setVisible(true);
                vista.setLocationRelativeTo(null);
                this.dispose();
            }
