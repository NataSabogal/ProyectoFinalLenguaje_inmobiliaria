 ...
 */
public class ControladorPropiedadesActivasEmpleado {

    DAOInmueble daoI;
    Empleado empleado;

    public ControladorPropiedadesActivasEmpleado(Empleado empleado) {
    ...
    public DefaultTableModel llenarPropiedadesActivasEmpleado() {
        ...
        ArrayList<Inmueble> lista = filtrarInmuebleActivosPorEmpleado(daoI.getInmuebles());
    ...
    private ArrayList<Inmueble> filtrarInmuebleActivosPorEmpleado(ArrayList<Inmueble> inmuebles) {
        ArrayList<Inmueble> salida = new ArrayList();
        for (int i = 0; i < inmuebles.size(); i++) {
            if (inmuebles.get(i).isActivo() && inmuebles.get(i).getEmpleado().getCedula().equals(empleado.getCedula())) {
